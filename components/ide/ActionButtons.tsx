    ...
    return (
        <div className="flex justify-between">
            ...
            <div className="text-white flex gap-x-3">
                <CustomButton text="Run" icon="/ide/run.svg" style={'bg-easy text-white'} onClick={onRun} />
                <CustomButton text="Save" icon="/ide/save.svg" style={'bg-dark_orange text-white'} onClick={onSave} />
            </div>
        </div>
    )
}
